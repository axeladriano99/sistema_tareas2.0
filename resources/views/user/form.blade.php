        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    {{ Form::number('DNI', $user->DNI, ['class' => 'form-control' . ($errors->has('DNI') ? ' is-invalid' : ''), 'placeholder' => 'Dni', 'id' => 'dni']) }}
            ...
            <div class="form-group">
                {{ Form::label('Area') }}
                {{ Form::select('idArea', $area, $user->idArea, ['class' => 'form-control' . ($errors->has('idArea') ? ' is-invalid' : '')]) }}
