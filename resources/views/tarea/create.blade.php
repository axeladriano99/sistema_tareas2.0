...
@section('content')
        ...
        fint-size: 48px; color:black; ">
            <div class="col-md-12">
                ...
                <a href="{{route('tareas.index')}}"  class="btn btn-success"> Lista de Tareas</a>
                <br><br>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            <div class="box box-info padding-1">
                                ...
                                <div class="form-group">
                                    {{ Form::label('Usuario') }}
                                    {{ Form::select('idUsuario', $usuarios, null, ['class' => 'form-control' . ($errors->has('idUsuario') ? ' is-invalid' : ''), 'placeholder' => 'Usuario']) }}
