        ...
        <div class="col-12" style="padding: 10px;font-family: 'Oswald', sans-serif;
         color:black; ">
            <div class="float-right">
                <a href="{{ route('home.create') }}" class="btn btn-success btn-sm float-right" data-placement="left">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <a class="btn btn-sm btn-success"
                                                        href="{{ route('actualizarTecnico.edit', $tareas->id) }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="modal" id="modalIniciar{{ $tareas->id }}">
                                                    <!-- Contenido del modal -->
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
